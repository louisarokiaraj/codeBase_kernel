...
void *hello_test(int arg1, void *arg2){
        char *argv[] = {NULL};
        char *envp[] = {NULL};
...
int call_hello_test(kshell_t *inShell,int arg1, char **arg2){
        int ret_status;
        proc_t *hello_self_test = proc_create("hello");
        dbg(DBG_PRINT, "Hello Test Started\n");
        kthread_t *hello_self_test_thr = kthread_create(hello_self_test,&hello_test,0,NULL);
        sched_make_runnable(hello_self_test_thr);
        do_waitpid(hello_self_test->p_pid,0,&ret_status);
        dbg(DBG_PRINT, "Hello Test Completed Successfully\n");
        return NULL; 
}

void *fork_test(int arg1, void *arg2){
        char *argv[] = {NULL};
        char *envp[] = {NULL};
...
int call_fork_test(kshell_t *inShell,int arg1, char **arg2){
        int ret_status;
        proc_t *fork_self_test = proc_create("fork");
        dbg(DBG_PRINT, "Fork Test Started\n");
        kthread_t *fork_self_test_thr = kthread_create(fork_self_test,&fork_test,0,NULL);
        sched_make_runnable(fork_self_test_thr);
        do_waitpid(fork_self_test->p_pid,0,&ret_status);
        dbg(DBG_PRINT, "Fork Test Completed Successfully\n");
        return NULL; 
}

void *readme_test(int arg1, void *arg2){

        
        char *argv[] = {"/bin/stat","/README",NULL};
        char *envp[] = {NULL};
        kernel_execve("/bin/stat", argv, envp);
        return NULL;
}

int call_readme_test(kshell_t *inShell,int arg1, char **arg2){
        int ret_status;
        proc_t *readme_self_test = proc_create("readme");
        dbg(DBG_PRINT, "readme Test Started\n");
        kthread_t *readme_self_test_thr = kthread_create(readme_self_test,&readme_test,0,NULL);
        sched_make_runnable(readme_self_test_thr);
        do_waitpid(readme_self_test->p_pid,0,&ret_status);
        dbg(DBG_PRINT, "readme Test Completed Successfully\n");
        return NULL; 
}

void *usr_test(int arg1, void *arg2){

        int fd1=do_open("/dev/tty0", O_RDONLY);
        int fd2 = do_open("/dev/tty0", O_WRONLY);
        char *argv[] = {"/bin/stat","/usr",NULL};
        char *envp[] = {NULL};
        kernel_execve("/bin/stat", argv, envp);
        do_close(fd1);
        do_close(fd2);
...
int call_usr_test(kshell_t *inShell,int arg1, char **arg2){
        int ret_status;
        proc_t *usr_self_test = proc_create("usr");
        dbg(DBG_PRINT, "usr Test Started\n");
        kthread_t *usr_self_test_thr = kthread_create(usr_self_test,&usr_test,0,NULL);
        sched_make_runnable(usr_self_test_thr);
        do_waitpid(usr_self_test->p_pid,0,&ret_status);
        dbg(DBG_PRINT, "usr Test Completed Successfully\n");
        return NULL; 
}



void *uname_test(int arg1, void *arg2){
...
int call_uname_test(kshell_t *inShell,int arg1, char **arg2){
        int ret_status;
        proc_t *uname_self_test = proc_create("uname");
        dbg(DBG_PRINT, "uname Test Started\n");
        kthread_t *uname_self_test_thr = kthread_create(uname_self_test,&uname_test,0,NULL);
        sched_make_runnable(uname_self_test_thr);
        do_waitpid(uname_self_test->p_pid,0,&ret_status);
        dbg(DBG_PRINT, "uname Test Completed Successfully\n");
        return NULL; 
}
/**
...
initproc_run(int arg1, void *arg2)
{
    ...
    kshell_add_command("hello",call_hello_test,"Run hello_test().");
    kshell_add_command("fork",call_fork_test,"Run fork_test().");
    kshell_add_command("readme",call_readme_test,"Run readme_test().");
    kshell_add_command("usr",call_usr_test,"Run usr_test().");
    kshell_add_command("uname",call_uname_test,"Run uname_test.");
